  ...
  return (
    <div className="min-h-[50vh] bg-gradient-to-r flex flex-col justify-start items-center text-[#344054] px-4 py-8">
      <div className="max-w-4xl w-full relative">
        {/* Timeline line - Starts and ends at the first and third circles */}
        <div className="absolute left-1/2 w-0.5 top-[70px] bottom-[100px] border-l-2 border-dashed border-[#1D2939] transform -translate-x-1/2 md:block hidden"></div>
